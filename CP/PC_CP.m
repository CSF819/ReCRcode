function [RCP_skeleton,Acell,Bcell,Ccell,Time_CAPA_Partition,Time_PC_CAPA,originalSize_currentSize_maxSubsetSize] = PC_CP(data,skeleton,conSize,Ds_order,Ds_Temp,Acell,Bcell,Ccell)
